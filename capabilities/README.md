...
9. **Capture wave (2026-09-18)**: deepseek + kimi + tencent-aistudio sessions
   ...
   copilot/hunyuan captures; tencent-aistudio selectors pending a clean
   headed round-trip.
10. Then: rest of the provider catalog (gemini-business, and any others) as requested.